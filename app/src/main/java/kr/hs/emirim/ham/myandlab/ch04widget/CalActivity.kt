    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnAdd).setOnClickListener{
            try{
                ...
                Toast.makeText(this, "뭔가 좀 입력해주시죠? -_-+",Toast.LENGTH_SHORT).show();
            }catch(e:NumberFormatException){
                Toast.makeText(this, "숫자만 입력해 주시죠 -_-+",Toast.LENGTH_SHORT).show();
            }
            catch (e:Exception){
                Toast.makeText(this, "뭔가 알 수 없는 예외 발생",Toast.LENGTH_SHORT).show();
